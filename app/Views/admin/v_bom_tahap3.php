<div class="col-md-12">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">BOM Tahap 3</h3>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            function generateKodeOtomatis()
            {
                ...
                return 'BOM3-' . $tanggal . $randomNumber;
            }
            ...
            <div class="row">
                    <div class="col-md-6">
                        <input type="hidden" name="process_step_id" value="3">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="bom_version" class="form-control" value="3" readonly>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody id="bom-details">
                        <tr>
                            <td>
                                <!-- tambah tampilkan juga dari hasil tahap 2 -->
                            ...
                            <td>
                                <input type="number" name="level[]" class="form-control" value="3" readonly>
                            </td>
                            <td>
