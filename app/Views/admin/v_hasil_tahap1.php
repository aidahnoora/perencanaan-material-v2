<div class="col-md-12">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Hasil Produksi Tahap 1</h3>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Data Hasil Pembahanan (Tahap 1)</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="">BOM</label>
                            <input type="text" name="bom" class="form-control" value="Tahap 1" readonly>
                            <input type="hidden" name="type" value="tahap1">
                            <input type="hidden" name="source_process_step_id" value="1">
                        </div>
